...
*/
    ...
    var
        game_server = module.exports = { theGame: {} },
    ...
    game_server.createGame = function() {
        ...
        this.theGame.id = UUID()            //for simple checking of state

    

            //Create a new game core instance, this actually runs the
            //game code like collisions and such.
        this.theGame.gamecore = new game_core( this.thegame );
            //Start updating the game loop on the server
        this.theGame.gamecore.update( new Date().getTime() );
